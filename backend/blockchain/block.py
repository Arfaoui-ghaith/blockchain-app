...
class Block:
    ...
    # Store transactions in a blockchain that sipports a cryptocurrency.
    ...
    def adjust_difficulty(last_block, new_timestamp):
        ...
        # Descrease the difficulty for slowly mined blocks.
...
def main():
    ...
    bad_block = Block.mine_block(genesis_block, "bar")
